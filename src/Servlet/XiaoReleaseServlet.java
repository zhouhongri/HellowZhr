...
public class XiaoReleaseServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		rs.insertXiaoActivity(zmenu, checkval, input1, input2, jjnumval, input3,yname,"xpjj",userid);
		PrintWriter out = resp.getWriter();
		List list = rs.queryXiaoActivity("xpjj");
		if(list.size()>0){
			rs.delxiaoacmessage("xpjj");
			out.write("发布成功！");
			out.flush();
			out.close();
		}else{
