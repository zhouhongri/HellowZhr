...
public class AcProductionTwoServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String yzcipt = req.getParameter("yzcipt");
		if(yzcipt!=null){
			yzcipt = URLDecoder.decode(yzcipt,"UTF-8");
		}
		List<Map<String, Object>> list2 = rs.yuanqueryActivity(yzcipt,yname,"ypzc");
		if(list2.size()>0){
		...
		//acyearbegin = new SimpleDateFormat("yyyy-MM-dd").format(acyearbegin);
		...
		if(aczmenu.contains("教学管理")){
	   	...
	   	req.getRequestDispatcher("activityproductiontwo.jsp").forward(req, resp);
	}
}
