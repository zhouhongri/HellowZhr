...
public class XiaoDelExistDataServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        rs.delXiaoAcMessage(userid,flag);
        List list1 = rs.queryXiaoAcMessage(userid,flag);
        ...
        List list2 = rs.queryXiaoAcMessage(userid,flag);
