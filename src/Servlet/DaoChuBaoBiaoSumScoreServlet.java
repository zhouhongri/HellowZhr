...
public class DaoChuBaoBiaoSumScoreServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if("ypjj".equals(flag)){
			...
			if(xname!=null&&!"全部".equals(xname)&&!"".equals(xname)){
				exportExcel(header,list,listyname,listtemp,"exportAllOrder",resp,xname+"评奖金");
			}
			exportExcel(header,list,listyname,listtemp,"exportAllOrder",resp,flag);
		}
		
	}
	public  final static void exportExcel(List<String> header,List<String> list,List<String> listyname,List<Map<String,Object>> listtemp,String type,HttpServletResponse response,String flag) {
        // 以下开始输出到EXCEL
        try {   
         response.setHeader("Content-disposition", "attachment; filename="+ new String((flag+"总分.xls").getBytes("GB2312"),"ISO8859-1"));
         ...
         if(listtemp!=null&&listtemp.size()>0){
             ...
             for(int j=0;j<scount;j++){
                 ...
                 sheets[j].addCell(new Label(0, 0, "评"+flag+"人员作品的总分数", wcf_center));
