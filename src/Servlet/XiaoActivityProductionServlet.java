...
public class XiaoActivityProductionServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Map<String, Object>> list2 = rs.xiaoqueryActivity("NULL","xpjj");
		if(list2.size()>0){
		...
		if(aczmenu.contains("教学管理")){
	   	...
	   	req.getRequestDispatcher("xiaoactivityproduction.jsp").forward(req, resp);
	}
}
