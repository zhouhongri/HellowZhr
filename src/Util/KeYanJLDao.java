...
public class KeYanJLDao {
	...
	static DBConnectionManage dbcm = new DBConnectionManage();
	  public static void update(String id,String[] list, String idtentity, String time){
		  ...
		  String sql="UPDATE keyanjiangli SET name = ?,author=?,authorseq=?,url=?,score=?,rank=?,score2=?,search=?,time=to_date('"+time+"','yyyy-mm-dd')";
	  ...
	  public static void del(String id){
		  ...
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "DELETE FROM keyanjiangli WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
	  ...
	  public static void pass(String id){
		  ...
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "UPDATE keyanjiangli SET status = 1 WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
	  ...
	  public static void pass2(String id){
		  ...
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "UPDATE keyanjiangli SET status2 = 1 WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
	  ...
	  public static void nopass(String id){
		  ...
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "UPDATE keyanjiangli SET status = 2 WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
	  ...
	  public static void nopass2(String id){
		  ...
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "UPDATE keyanjiangli SET status2 = 2 WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
