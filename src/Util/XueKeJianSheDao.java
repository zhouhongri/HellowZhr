	...
	static DBConnectionManage dbcm = new DBConnectionManage();
	  ...
	  public static void del(String id){
		//Connection con=DBConnection.getconnection();
		  ...
		  String sql = "DELETE FROM xueke WHERE id = ?";
		  try {
	  ...
	  public static void update(String id,String[] list, String idtentity,String time){
		//Connection con=DBConnection.getconnection();
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql="UPDATE xueke SET name = ?,rank=?,author=?,authorseq=?,url=?,score=?,score2=?,search=?,time=to_date('"+time+"','yyyy-mm-dd')";
	  ...
	  public static void pass(String id){
		//Connection con=DBConnection.getconnection();
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "UPDATE xueke SET status = 1 WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
	  ...
	  public static void pass2(String id){
		//Connection con=DBConnection.getconnection();
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "UPDATE xueke SET status2 = 1 WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
	  ...
	  public static void nopass(String id){
		//Connection con=DBConnection.getconnection();
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "UPDATE xueke SET status = 2 WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
	  ...
	  public static void nopass2(String id){
		//Connection con=DBConnection.getconnection();
		  Connection con = dbcm.getConnection();
		  PreparedStatement ps=null;
		  String sql = "UPDATE xueke SET status2 = 2 WHERE id = ?";
		  try {
			ps = con.prepareStatement(sql);
			ps.setString(1, id);
			ps.executeUpdate();
