...
public class ZhuanLiService {
	...
	public List<Map<String, Object>> queryAll(String currpage, String everycount,String userid, String year, String status,String flag, String inputvalue) {
		...
		String sql=null;
		//开始拼接sql语句
		sql = "select * from (select rownum as num,l.* from zhuanli l where authorid=" + userid;
	...
	public List<Map<String, Object>> queryByCollege(String currpage, String everycount,String college, String year, String status,String flag, String inputvalue, String yrank,String school) {
		...
		String sql=null;
		//开始拼接sql语句
		sql = "select * from (select rownum as num,l.*,u.* from zhuanli l left join uploadfilemessage u on l.id=u.zuopinid where u.zuopintype='zhuanli' and authorid in (select id from users where college = '"+college+"' and school ='"+school+"')";
	...
	public List<Map<String, Object>> queryAllColloge(String currpage, String everycount, String year, String status,String flag, String inputvalue, String yrank,String school) {
		...
		String sql=null;
		//开始拼接sql语句
		sql = "select * from (select rownum as num,l.*,u.* from zhuanli l left join uploadfilemessage u on l.id=u.zuopinid where u.zuopintype='zhuanli' and authorid in (select id from users where school = '"+school+"')" ;
	...
	public List<Map<String, String>> totalcount(String userid, String year, String status,String flag, String inputvalue) {
		...
		String[] array = {};
		String sql = null;
		sql = "select count(*) a from zhuanli where authorid="+ userid;
	...
	public List<Map<String, String>> totalcount1(String college, String year, String status, String flag, String inputvalue, String yrank,String school) {
		...
		String[] array = {};
		String sql = null;
		sql = "select count(*) a from zhuanli where authorid in (select id from users where college = '"+college+"' and school = '"+school+"')";
		if(flag==null){
			flag="";
		}
		if(!year.equals("-1")&&!"pass".equals(flag)){
