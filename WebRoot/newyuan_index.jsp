            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item">
                   	...
                   	<li class="tpl-left-nav-item">
                        <a href="atyrls?flag=success" target="mainFrame" class="nav-link tpl-left-nav-link-list">
                            <i class="am-icon-bullhorn"></i>
                            <span>院活动发布</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="yglscoreej?datav=1" target="mainFrame" class="nav-link tpl-left-nav-link-list">
                    ...
                    %>
                        ...
                        <a href="queryauthors?currpage=1" target="mainFrame" class="nav-link tpl-left-nav-link-list">
