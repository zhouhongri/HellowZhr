$(document).ready(function() {
  ...
  var content = [{
    title: "欢迎您，您已成功登录",
    desc: "welcome, you have logged in"
  }, {
    title: "欢迎来到精于算绩",
    desc: "welcome to JYSJ"
  }, {
    title: "这里可以为高校教师提供绩效的数据统计和报表展现",
    desc: "we provide university teachers with data statistics and report display of performance-related pay"
  }, {
    title: "希望您使用愉快",
    desc: "enjoy your time with us"
  }];
  var currentPage = 0;
  //generate content
