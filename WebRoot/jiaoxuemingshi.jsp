...
var crpge = 1;
	...
	function changetable() {
		...
		var url = "queryjxms?currpage=" + crpge + "&year=" + yearvalue
	...
	function test(userid) {
		...
		if (rank == "-1") {
			...
			var url = "queryjxms?rank=" + encodeURI(encodeURI(rank))
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="zzmz" id="zzmz" value="${username}" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group" >
					...
					<li style="display: none;">
						...
						<li style="display: none;">
							<input class="ipt" type="text" name="type" value="jiaoxuemingshi" size="20" />
						</li>
