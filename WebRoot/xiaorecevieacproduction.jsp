...
<script type="text/javascript">
	    ...
	    function danchuacprd(id,sltnameval){
  			...
  			bb1.href="xiaoexportzc?sltnameval="+encodeURI(encodeURI(sltnameval))+"&flag=xpjj"+"&id="+id;
 		}
  		function danchuacscore(){
  			var bb2 = document.getElementById("bb2");
  			var college = document.getElementById("collegeipt").value;
  			bb2.href="xiaoexportscorezc?flag=xpjj"+"&college="+encodeURI(encodeURI(college));
  		}
  		function danchuacsumscore(){
  			var bb3 = document.getElementById("bb3");
  			var college = document.getElementById("collegeipt").value;
  			bb3.href="xiaoexportsumscorezc?flag=xpjj"+"&college="+encodeURI(encodeURI(college));
  		}
  		
		function prevPage(){
			var page = check("prevPage");
			if(page!="-1"){
				window.location.href = "queryxiaoauthors?currpage="+page;
			}
		}
	...
	function keyLogin(e){
  	...
  	function changecollege(rownum,college){
  		...
  		id.href="queryxiaoauthors?currpage=1"+"&college="+encodeURI(encodeURI(college));
  	}  		
  	</script>
...
<body>
  ...
  <input type="text" value="${college}" id="collegeipt" style="display: none;"/>
	...
	<ul class="pagination" style="float:right;">
		...
		<li><a href="queryxiaoauthors?currpage=1">首页</a></li>
		...
		<li><a href="queryxiaoauthors?currpage=${pagecount}">末页</a></li>
	</ul>
