     ...
     <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-type am-hide-sm-only">申办日期</th>
                                            <th class="table-type am-hide-sm-only">主持人</th>
                                            <th class="table-type am-hide-sm-only">主持人排序</th>
...
<div class="modal fade" id="modal-container-834996" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
   ...
   //上传文件
	...
	function tiaozhuan(pagecount) {
	    ...
	    var url = "queryjxyjxm?currpage="+inputnum+"&year="+yearvalue+"&status="+ statusvalue+"&inputvalue=" + inputvalue;
