...
var crpge = 1;
	...
	function changetable() {
		...
		var url = "querysysjs?currpage=" + crpge + "&year=" + yearvalue
	...
	function test(userid) {
		...
		if (rank == "-1") {
			...
			var url = "querysysjs?rank=" + encodeURI(encodeURI(rank))
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>实验室名</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="name" id="name"/>
						</div>
					</div>
					<div class="form-group" >
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>申请时间</label>
						<div class="col-sm-10">
					...
					<li style="display: none;">
						...
						<li style="display: none;">
							<input class="ipt" type="text" name="type" value="shiyanshijianshe" size="20" />
						</li>
