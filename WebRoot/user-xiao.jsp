...
$(function (){
	...
	$("#sb").bind("click",function(){
    	...
    	if(!$("#ylist").val()||$.trim($("#ylist").val())=="-1"){
    	layer.tips("请填写院名!","#ylist",{
    	tips:[2,"#FF7F24"]
    	});
    	return false;
    	} 
				...
				<div class="panel panel-default" style="width: 100%;">
					...
					<div class="panel-body">
						...
						<div class="btn-group">
							...
							<button class="btn btn-default" id="sel1" value="-1">学院</button>
							...
							<ul class="dropdown-menu" style="overflow-y: auto;" id="nful">
								...
								<c:forEach items="${ylist }" var="y">
									<li value="${y }"><a href="javascript:;">${y }</a></li>
								</c:forEach>
							</ul>
