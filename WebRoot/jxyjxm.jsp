...
//上传文件
	...
	function changetable() {
		...
		var url = "queryjxyjxm?currpage=" + crpge + "&year=" + yearvalue
	...
	function test(userid) {
		...
		if (rank == "-1") {
			...
			var url = "queryjxyjxm?rank=" + encodeURI(encodeURI(rank))
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">主持人工号</label>
						<div class="col-sm-10">
					...
					<li style="display: none;">
						...
						<li style="display: none;">
							<input class="ipt" type="text" name="type" value="jxyjxm" size="20" />
						</li>
