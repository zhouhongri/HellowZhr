...
var crpge = 1;
	$(function() {
    	...
    	layer.tips("请填写教材名!","#name",{
    	tips:[2,"#FF7F24"]
    	});
    	return false;
    	}
    	if(!$("#chubanshe").val()||$.trim($("#chubanshe").val())==""){
    	layer.tips("请填写出版社!","#chubanshe",{
    	tips:[2,"#FF7F24"]
    	});
    	return false;
    	}
    	if(!$("#year").val()||$.trim($("#year").val())==""){
    	layer.tips("请选择出版日期!","#year",{
    	tips:[2,"#FF7F24"]
    	});
    	return false;
    	}
	...
	function changetable() {
		...
		var url = "queryjczz?currpage=" + crpge + "&year=" + yearvalue
	...
	function test(userid) {
		...
		if (rank == "-1") {
			...
			var url = "queryjczz?rank=" + encodeURI(encodeURI(rank))
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>教材名</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="chubanshe" id="chubanshe"/>
						</div>
					</div>
					<div class="form-group" >
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>出版日期</label>
						<div class="col-sm-10">
					...
					<li style="display: none;">
						...
						<li style="display: none;">
							<input class="ipt" type="text" name="type" value="jiaocaizhuzuo" size="20" />
						</li>
