     ...
     <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-type am-hide-sm-only">时间</th>
                                            <th class="table-type am-hide-sm-only">讲师</th>
                                            <th class="table-type am-hide-sm-only">讲师排序</th>
                                    ...
                                    <tbody>
                                    <c:if test="${fn:length(kcjsList)==0}"> 
										<tr align="center">
											<td colspan="15" style="color:red;">查询无结果</td>
										</tr>
										</c:if>
										<c:forEach items="${kcjsList}" var="a">
                                        <tr id="tr${a.id}">
                                            <td></td>
                                            <td>${a.name}</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">讲师</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="author" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">讲师排序</label>
						<div class="col-sm-10">
					...
					<ol style="display: none;">
						<li style="display: none;">
							...
							<input style="display: none;" class="ipt" type="text" name="type" value="kechengjianshe" size="20" />
						</li>
						<li style="display: none;">
 ...
 <script src="assets/js/jquery.min.js"></script>
   ...
   $("#mainFrame",parent.document).css("height",tableHeight);
	...
	function tiaozhuan(pagecount) {
	    ...
	    var url = "querykcjs?currpage="+inputnum+"&year="+yearvalue+"&status="+ statusvalue+"&inputvalue=" + inputvalue+"&yrank="+yrankvalue;
	...
	function callback() {
		...
		var url="querykcjs?rank="+encodeURI(encodeURI(rank))+"&authorseq="+authorseq+"&userid="+userid+"&index=1";
		xmlHttp.open("POST", url, true);
		xmlHttp.send(null)}
	}
	function callback2() {
