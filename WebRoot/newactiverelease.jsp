                ...
                <div class="portlet-title">
                    <div class="caption font-green bold">
						...
						<div class="panel-body">
								<strong>年度：</strong>
							    <strong class="stg">
							    <input type="date" id="input1" onchange="changetime();"style="width: 155px;height: 26px;"/>到
							   	<input type="date" id="input2" onchange="changetime();"style="width: 155px;height: 26px;"/>
							   	</strong><br><br>
								<strong>截止时间：</strong> 
								<strong class="stg">
								<input type="date" id="input3" onchange="musttime();"style="width: 155px;height: 26px;"/>
							 	</strong><br><br>  
									<%
