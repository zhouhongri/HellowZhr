...
//上传文件
	...
	function changetable() {
		...
		var url = "queryxszz?currpage=" + crpge + "&year=" + yearvalue
	...
	function test(userid) {
		...
		if (rank == "-1") {
			...
			var url = "queryxszz?rank=" + encodeURI(encodeURI(rank))
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<li style="display: none;">
						...
						<li style="display: none;">
							<input class="ipt" type="text" name="type" value="xueshuzhuzuo" size="20" />
						</li>
