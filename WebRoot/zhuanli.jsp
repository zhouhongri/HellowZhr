...
var crpge = 1;
	...
	function changetable() {
		...
		var url = "queryzl?currpage=" + crpge + "&year=" + yearvalue
	...
	function test(userid) {
		...
		if (rank == "-1") {
			...
			var url = "queryzl?rank=" + encodeURI(encodeURI(rank))
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="zlmz" id="zlmz"/>
						</div>
					</div>
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>专利号</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="zlh" id="zlh"/>
						</div>
					</div>
					<div class="form-group" >
