...
<html>
  <head>
	...
	<script type="text/javascript">
			...
			var url = "ckhf?checkval="+encodeURI(encodeURI(checkval))+"&flag="+"ypzc";
			...
			function delExistData(checkval){
				...
				var url = "dletda?checkval="+encodeURI(encodeURI(checkval))+"&flag="+"ypzc";
				xmlHttp.open("POST", url, true);
				xmlHttp.send(null);
			}
  ...
  <body>
  	<div>
  		<strong id="str0">评 ${jobname} 的教师请提交作品，</strong>
