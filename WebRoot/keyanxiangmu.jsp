...
var crpge = 1;
	$(function() {
	   ...
	   $("#sb").bind("click",function(){
    	if(!$("#xmmz").val()||$.trim($("#xmmz").val())==""){
    	layer.tips("请填写项目名!","#xmmz",{
    	tips:[2,"#FF7F24"]
    	});
    	return false;
    	}
	...
	function changetable() {
		...
		var url = "querykyxm?currpage=" + crpge + "&year=" + yearvalue
	...
	function test(userid) {
		...
		if (rank == "-1") {
			...
			var url = "querykyxm?rank=" + encodeURI(encodeURI(rank))
			...
			<div class="col-md-12 column"
				...
				<div class="panel panel-default" style="width: 100%;">
					<div class="panel-heading">
						<a  id="modal-834996" role="button" href="#modal-container-834996" data-toggle="modal"><input type="button" class="btn btn-default"  value="新增"></a>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>项目名</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="xmmz" id="xmmz"/>
						</div>
					</div>
					<div class="form-group" >
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>时间</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">负责人</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="zzmz" readonly="readonly" value="${username}"/>
						</div>
					</div>
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">负责人工号</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="zzgh" value="${userid}" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">负责人排序</label>
						<div class="col-sm-10">
					...
					<div class="form-group"  style="display: none;">
						...
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="df" id="df" readonly="readonly" />
						</div>
					</div>
					<div class="form-group"  style="display: none;">
					 	<label class="col-sm-2 control-label" for="inputEmail3">校得分</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="df2" id="df2" readonly="readonly" />
						</div>
					</div>
					<div class="form-group">
					...
					<%
					 ...
					 %>
					 	<label class="col-sm-2 control-label" for="inputEmail3" data-toggle="tooltip" data-placement="left" title=""><span style="color:red; font-size:20px;">*</span>等级<i class="glyphicon glyphicon-question-sign"></i></label>
						<div class="col-sm-10">
					...
					<li style="display: none;">
						...
						<li style="display: none;">
							<input class="ipt" type="text" name="type" value="keyanxiangmu" size="20" />
						</li>
