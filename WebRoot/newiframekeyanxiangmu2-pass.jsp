     ...
     <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-type am-hide-sm-only">参与时间</th>
                                    ...
                                    <tbody>
                                    <c:if test="${fn:length(kyxmList)==0}"> 
										<tr align="center">
											<td colspan="15" style="color:red;">查询无结果</td>
										</tr>
										</c:if>
										<c:forEach items="${kyxmList}" var="a">
                                        <tr id="tr${a.id}">
                                            <td></td>
                                            <td>${a.name}</td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="name" id="xmmz"/>
						</div>
					</div>
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>参与时间</label>
						<div class="col-sm-10">
					...
					<ol style="display: none;">
						<li style="display: none;">
							...
							<input style="display: none;" class="ipt" type="text" name="type" value="keyanxiangmu" size="20" />
						</li>
						<li style="display: none;">
 ...
 <script src="assets/js/jquery.min.js"></script>
   ...
   $("#mainFrame",parent.document).css("height",tableHeight);
	...
	function tiaozhuan(pagecount) {
	    ...
	    var url = "querykyxm?currpage="+inputnum+"&year="+yearvalue+"&status="+ statusvalue+"&inputvalue=" + inputvalue+"&yrank="+yrankvalue;
	...
	function callback() {
		...
		var url="querykyxm?rank="+encodeURI(encodeURI(rank))+"&authorseq="+authorseq+"&index=1";
		xmlHttp.open("POST", url, true);
		xmlHttp.send(null)}
	}
	function callback2() {
