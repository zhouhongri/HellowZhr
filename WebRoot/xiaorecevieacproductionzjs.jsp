...
<script type="text/javascript">
  		function danchuacprd(id,sltnameval){
  			...
  			bb1.href="xiaoexportzc?sltnameval="+encodeURI(encodeURI(sltnameval))+"&flag=xpzc"+"&jobname="+encodeURI(encodeURI("教授"))+"&id="+id;
  		}
  		function danchuacscore(){
  			var bb2 = document.getElementById("bb2");
  			var college = document.getElementById("collegeipt").value;
  			bb2.href="xiaoexportscorezc?flag=xpzc"+"&jobname="+encodeURI(encodeURI("教授"))+"&college="+encodeURI(encodeURI(college));
  		}
  		function danchuacsumscore(){
  			var bb3 = document.getElementById("bb3");
  			var college = document.getElementById("collegeipt").value;
  			bb3.href="xiaoexportsumscorezc?flag=xpzc"+"&jobname="+encodeURI(encodeURI("教授"))+"&college="+encodeURI(encodeURI(college));
  		}
	...
	function keyLogin(e){
  	...
  	function changecollege(rownum,college){
  		...
  		id.href="queryxiaoauthorszc?currpage=1"+"&college="+encodeURI(encodeURI(college))+"&jobname=zjs";
  	} 
  	</script>
