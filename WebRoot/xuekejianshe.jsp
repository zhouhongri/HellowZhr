...
var crpge = 1;
	...
	function changetable() {
		...
		var url = "queryxkjs?currpage=" + crpge + "&year=" + yearvalue
	...
	function test(userid) {
		...
		if (rank == "-1") {
			...
			var url = "queryxkjs?rank=" + encodeURI(encodeURI(rank))
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>学科名</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="lwbt" id="lwbt" />
						</div>
					</div>
					<div class="form-group" >
					...
					<li style="display: none;">
						...
						<li style="display: none;">
							<input class="ipt" type="text" name="type" value="xueke" size="20" />
						</li>
