                ...
                <div class="portlet-title">
                    ...
                    <div class="am-btn-group-xs right am-form-group am-form-file">
								...
								<button type="button" class="am-btn am-btn-default am-btn-sm" id="up">
  								...
  								<input type="file" multiple="multiple" size="1" style="display: none;" id="fileipt" name="uploadfile">
  								</form>
                ...
                <div class="tpl-block">
                    <div class="am-g">
                        ...
                        <div class="am-u-sm-12 am-u-md-3" onclick="xiaoshiyear();">
            					...
            					<option style="display:none" value="-1" selected="selected" id="xsyear">系别</option>
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <div class="am-input-group am-input-group-sm">
                                <input type="text" class="am-form-field" id="sousuoinput" value="">
