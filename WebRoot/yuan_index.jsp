    ...
    <section id="container">
                     ...
                     <%String id = (String)session.getAttribute("userid");
                      ...
                      %><%=name %><i class="fa fa-angle-down"></i>
                        ...
                        <ul class="dropdown-menu animated fadeInDown">
                        	<li>
                                <a id="modal-919425" role="button" href="#modal-container-919425" data-toggle="modal"><i class="fa fa-user" ></i>修改密码</a>
                            </li>
        ...
        <aside class="sidebar" >
            <div id="leftside-navigation" class="nano">
                ...
                <!-- 
                    <li class="">
                        <a href="grxx?flag=ygly" target="mainFrame"><i class="glyphicon glyphicon-user"></i><span>个人信息</span></a>
                    </li> -->
                    <%
                    ...
                    <li class="">
                     ...
                     <li class="">
                        <a href="atyrls?flag=success" target="mainFrame"><i class="glyphicon glyphicon-pencil"></i><span>院活动发布</span></a>
                    </li>                   	 
                   	 <input type="text" id="yzcipt" value="" style="display: none;">
                    ...
                    <%
                        ...
                        for(String s : ZnameList){
                        	if("0".equals(s)&&!identity.equals("-1")){
                        	%>
                    ...
                    <%	
                        	...
                        	if(s.equals("1")&&!identity.equals("-0")){
                        		%>
                            ...
                            <% String C1names[] = (String[])session.getAttribute("C1names");
                            	for(String c1 : C1names){
                            		if(c1.equals("10")){
                            			...
                            			%>
                            			<li><a href="querykcjs?currpage=1&userid=${userid}&index=1" target="mainFrame" target="mainFrame">课程建设管理</a></li>
                            			<%
                    ...
                    %>
                    <!-- 
                     <li class="active" id="bb">
                        <a href="dcbb?flag=success" target="mainFrame"><i class="glyphicon glyphicon-user"></i><span>导出报表</span></a>
                   	 </li>
                     -->
                   <li class="active" id="bb1" style="display: none;">
                        <a href="queryauthors?currpage=1" target="mainFrame"><i class="glyphicon glyphicon-user"></i><span>院评奖金活动作品</span></a>
                   	 </li>
