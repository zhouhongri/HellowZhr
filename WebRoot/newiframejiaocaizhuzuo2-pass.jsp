     ...
     <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">教材名</th>
                                            <th class="table-type am-hide-sm-only">出版社</th>
                                            <th class="table-author am-hide-sm-only">出版日期</th>
                                            ...
                                            <th class="table-type " style="display: none;">校级得分</th>
                                    ...
                                    <tbody>
                                    <c:if test="${fn:length(jczzList)==0}"> 
										<tr align="center">
											<td colspan="15" style="color:red;">查询无结果</td>
										</tr>
										</c:if>
										<c:forEach items="${jczzList}" var="a">
                                        <tr id="tr${a.id}">
                                            <td></td>
                                            <td>${a.name}</td>
                                            <td class="am-hide-sm-only">${a.chubanshe}</td>
                                            ...
                                            <td class="" style="display: none;">${a.score2}</td>
				...
				<div class="modal-body">
					...
					<ol style="display: none;">
						<li style="display: none;">
							...
							<input style="display: none;" class="ipt" type="text" name="type" value="jiaocaizhuzuo" size="20" />
						</li>
						<li style="display: none;">
 ...
 <script src="assets/js/jquery.min.js"></script>
   ...
   $("#mainFrame",parent.document).css("height",tableHeight);
	...
	function tiaozhuan(pagecount) {
	    ...
	    var url = "queryjczz?currpage="+inputnum+"&year="+yearvalue+"&status="+ statusvalue+"&inputvalue=" + inputvalue+"&yrank="+yrankvalue;
	...
	function callback() {
		...
		var url="queryjczz?rank="+encodeURI(encodeURI(rank))+"&authorseq="+authorseq+"&userid="+userid+"&index=1";
		xmlHttp.open("POST", url, true);
		xmlHttp.send(null)}
	}
	function callback2() {
