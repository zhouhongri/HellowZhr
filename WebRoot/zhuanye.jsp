...
//上传文件
    	...
    	if(!$("#zyname").val()||$.trim($("#zyname").val())==""){
    	layer.tips("请填写专业名!","#zyname",{
    	tips:[2,"#FF7F24"]
    	});
    	return false;
    	}
	...
	function changetable() {
		...
		var url = "queryzy?currpage=" + crpge + "&year=" + yearvalue
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3"><span style="color:red; font-size:20px;">*</span>专业名</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="zyname" id="zyname"/>
						</div>
					</div>
					<div class="form-group" >
					...
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">申办人</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="zzmz" readonly="readonly" value="${username}"/>
						</div>
					</div>
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">申办人工号</label>
						<div class="col-sm-10">
							<input class="form-control ipt"  type="text" name="zzgh" value="${userid}" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
					 	<label class="col-sm-2 control-label" for="inputEmail3">申办人排序</label>
						<div class="col-sm-10">
					...
					<li style="display: none;">
						...
						<li style="display: none;">
							<input class="ipt" type="text" name="type" value="zhuanye" size="20" />
						</li>
